...
SESSION_STRING = os.getenv('SESSION_STRING', '1AZWarzYBu20nj2LOfMytFR5eXcYT9neq_U9JS5pW8NRt1vlttyFZYaDZaE7sJACh2Y6QbccgdqAOlb52kEX1SJ-BAn-sbhL9QLri5kS4PVvMojqZs4XJEjY0nXZrIW-jE8987o-4XBS1E7aCQMimZVbjZ5oYmJbGnSz-aP0uev4zuCUVc1_N98Erl4fLWaQ11PgWpsCWi93pYrDU6iZmSH__XhtHG_ujjHz9HRPhtFMkl-3v0MFnmNyT2MDbBWR4M09exAb86R4PztT5P3pUpifLydCQUNVIdpE8S96cMoAX9s5t-c1_8Pguc-CGCuj4mlaVoNEjP3kQ_v1a1OTThaBOk72uak0=')
DB_URL = os.getenv('DB_URL', 'postgresql://neondb_owner:npg_Nd2D8BMWYGXj@ep-flat-snow-ah0dg0ip-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require')

# Configuración de Crypto
FREE_CRYPTO_API_TOKEN = "4hgzw1dnorurolqkpcg1"

# ☁️ OpenBullet API
OB_URL = "https://cloudfig10-001-site1.ktempurl.com/top/api/Configs"
